...
export const CLOSE_DEVTOOLS = 'CLOSE_DEVTOOLS';
export const OPEN_REMOTE_CONTROL = 'OPEN_REMOTE_CONTROL';
export const CLOSE_REMOTE_CONTROL = 'CLOSE_REMOTE_CONTROL';
...
export const RESET_TOKEN = 'visualization:reset';
